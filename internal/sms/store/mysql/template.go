...
func (t *templateStore) Get(ctx context.Context, id int64) (*model.TemplateM, error) {
...
func (t *templateStore) GetByTemplateCode(ctx context.Context, templateCode string) (*model.TemplateM, error) {
	var template model.TemplateM
